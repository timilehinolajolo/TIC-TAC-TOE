...
document.querySelector('.scoreX').innerHTML = `<img class='w-[70px]' src='/src/asset/x-icon.jpg'> <p>Wins: ${scoreX}</p>`;
document.querySelector('.scoreO').innerHTML = `<img class='w-[70px]' src='/src/asset/o-icon.jpg'> <p>Wins: ${scoreO}</p>`;
        ...
        if (winStatus(row, col)) {
            ...
            if (playerMove === 'X') {
                ...
                document.querySelector('.scoreX').innerHTML =
                    `<img class='w-[70px]' src='/src/asset/x-icon.jpg'> <p>Wins: ${scoreX}</p>`;
            } else {
                scoreO++;
                document.querySelector('.scoreO').innerHTML =
                    `<img class='w-[70px]' src='/src/asset/o-icon.jpg'> <p>Wins: ${scoreO}</p>`;
            }
            ...
            document.querySelector('.displayMove').innerHTML =
                `Turns: <img class='w-[70px]' src='/src/asset/${playerMove}-icon.jpg'>`;
        }
    } else {
